...
<body class="d-flex justify-content-center" style="background-color:gris;">
<!-- <body> -->
<header class="pages"> 
...
/*   <i class="fa-solid fa-user"></i> */
                while($data = $result->fetch()){
                    ...
                    <td style="display:flex; gap: 20px; justify-content:center;"">
                      <a href="../vus/swite.php?switeid='.$id.'"><i class="fa-solid fa-repeat"></i></a>
                      <a href="../vus/modification.php?modif='.$id.'"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a href="admin.php?archive='.$id.'" onclick="return confirm(\'Voulez vous vraimenr archiver ?\')"><i class="fa-solid fa-box-archive"></i></a>
